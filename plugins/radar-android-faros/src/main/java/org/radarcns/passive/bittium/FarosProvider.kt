...
class FarosProvider : DeviceServiceProvider<FarosDeviceStatus>() {
    ...
    override val permissionsNeeded: List<String> = listOf(ACCESS_COARSE_LOCATION, BLUETOOTH, BLUETOOTH_ADMIN)
