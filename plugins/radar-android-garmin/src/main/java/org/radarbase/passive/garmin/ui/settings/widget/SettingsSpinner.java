package org.radarbase.passive.garmin.ui.settings.widget;
...
public class SettingsSpinner<T> extends LinearLayout
{
    ...
    private String getString(T selectedOption)
    {
        ...
        {
            return org.radarbase.passive.garmin.ui.settings.util.TextUtils.toTitleCase((String)selectedOption);
        }
        ...
        try
        {
            ...
            {
                return org.radarbase.passive.garmin.ui.settings.util.TextUtils.toTitleCase(mContext.getString(resId));
            }
        }
        catch(Exception e)
        {
        ...
        return org.radarbase.passive.garmin.ui.settings.util.TextUtils.toTitleCase(selectedOption.toString());
    }
