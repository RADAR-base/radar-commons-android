...
import org.radarcns.android.device.DeviceService.Companion.CACHE_RECORDS_UNSENT_NUMBER
import org.radarcns.android.device.DeviceService.Companion.CACHE_TOPIC
import org.radarcns.android.kafka.KafkaDataSubmitter
import org.radarcns.android.kafka.ServerStatusListener
import org.radarcns.android.util.BatteryStageReceiver
...
class TableDataHandler(private val context: Context) : DataHandler<ObservationKey, SpecificRecord> {
    ...
    init {
        ...
        this.specificData = CacheStore.get().specificData
    ...
    override val activeCaches: List<DataCacheGroup<*, *>>
        get() {
            return if (submitter == null) {
                ...
                tables.values.filter { config.highPriorityTopics.contains(it.topicName) }
            }
        }
