...
abstract class DeviceService<T : BaseDeviceState> : Service(), DeviceStatusListener, LoginListener {
    ...
    override fun onDestroy() {
        ...
        (applicationContext as RadarApplication).onDeviceServiceDestroy(this)
    }
    ...
    private fun doBind(intent: Intent, firstBind: Boolean) {
        ...
        val extras = BundleSerialization.getPersistentExtras(intent, this)
        onInvocation(extras ?: Bundle())

        val application = applicationContext as RadarApplication
    ...
    companion object {
        ...
        const val CACHE_RECORDS_SENT_NUMBER = PREFIX + "DataCache.numberOfRecords.second"
